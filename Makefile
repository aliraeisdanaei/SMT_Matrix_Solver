...
CC = gcc
LIBS = -fopenmp
FILES = naive_solver.c optimised_solver.c main.c MatrixMarket/read_mtx.c MatrixMarket/mmio.c verifier.c DynamicList/dynamic_list.c
